...
- Animals (corrected 2026-09-05): wild pig (charges across trail at dawn/dusk, bite = hit), mongoose (ferret-shaped, darts underfoot — small stumble, no hit), feral chicken (harmless flavour, scatters in small groups), brush-tailed rock wallaby (hops across the trail in one high arc at dawn/dusk/night — collide = hit, duck under the arc; REAL: the Kalihi Valley colony, Petrogale penicillata, descended from a pair that escaped Richard Trent's private zoo on 20 Aug 1916 — sources: UH Mānoa ScholarSpace mtDNA study; Hawaii DLNR 2020-06-25 news release; Kalihi is the next valley from the Nu'uanu leg), giant centipede (on the trail at night, bite = hit), rat at night (harmless).
- Lore hazard — Huakaʻi Pō (Night Marchers), added 2026-09-05, treated respectfully: on ~1 night in 3 (1 in 2 under a full moon, seeded) a line of torches moves along the far ridge with low synthesised drums — no chants, no faces, no caricature. Rarely (at most once per night) a procession crosses the trail ahead; the legend's answer — do not look, get low — maps to the game's DUCK, held until they pass. Standing or jumping = a hit and the screen darkens for a beat. [Michael confirmed: DUCK; jumping or standing = hit.]
